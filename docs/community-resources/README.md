...
1. **资源搜索 Skill** (`examples/09-resource-search/`) - 搜索最新资料
2. **资源简报生成 Skill** (`examples/10-resource-briefing/`) - 生成定期简报
3. **更新日报生成 Skill** (`examples/11-update-daily-report/`) - 生成每日更新报告
